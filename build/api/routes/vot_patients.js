...
const vot_patients_1 = __importDefault(require("../../services/vot_patients"));
...
exports.default = (app) => {
    ...
    route.post('/add', middlewares_1.default.isAuth, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const patientServiceInstance = typedi_1.Container.get(vot_patients_1.default);
    ...
    route.post('/get', middlewares_1.default.isAuth, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const patientServiceInstance = typedi_1.Container.get(vot_patients_1.default);
            const result = yield patientServiceInstance.getVOTPatients();
            console.log("-------");
            console.log(result);
